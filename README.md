...
![Logo](https://d.uguu.se/kxEvbwpE.jpg)
...
# NPM
"dependencies": {
   "Um4r719/baileys": "latest"
}

# GitHub
"dependencies": {
   "Um4r719/baileys": "github:itsUmaraa/baileys"
}
```
...
```bash
# NPM
npm i Um4r719/baileys@latest

# GitHub
npm i github:Um4r719/baileys
```
...
```javascript
// --- ESM
import { makeWASocket } from 'Um4r719/baileys'

// --- CJS (tested and working on Node.js 24 ✅)
const { makeWASocket } = require('Um4r719/baileys')
```
...
```javascript
import { makeWASocket, delay, DisconnectReason, useMultiFileAuthState } from 'Um4r719/baileys'
import { Boom } from '@hapi/boom'
import pino from 'pino'

// --- Connect with pairing code
const myPhoneNumber = '923165123719'
...
```javascript
import { makeWASocket, makeInMemoryStore, delay, DisconnectReason, useMultiFileAuthState } from 'Um4r719/baileys'
import { Boom } from '@hapi/boom'
import pino from 'pino'
...
// --- Regular mention
sock.sendMessage(jid, {
   text: '👋🏻 Hello @923165123719',
   mentions: ['923165123719@s.whatsapp.net']
}, {
   quoted: message
})
...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Umar Rehman\n'
            + 'ORG:Waiters;\n'
            + 'TEL;type=CELL;type=VOICE;waid=923165123719:+923165123719\n'
            + 'END:VCARD'
...
sock.sendMessage('120363419188352267@newsletter', {
   poll: {
      name: '🔥 Quiz',
      values: ['Yes', 'No'],
      correctAnswer: 'Yes',
...
sock.sendMessage(jid, {
   ...
   publisher: '🌟 Umar Rehman',
   description: 'Um4r719/baileys'
}, {
   quoted: message
})
```
...
sock.sendMessage(jid, {
   ...
   couponCode: 'Um4r719/baileys', // --- Optional
   nativeFlow: [{
      text: '👋🏻 Greeting',
      id: '#Greeting'
   }, {
...
```javascript
// --- PN (Phone Number)
const phoneNumber = '923165123719@s.whatsapp.net'
...
// --- Output
// {
//    phoneNumber: '923165123719@s.whatsapp.net',
...
```javascript
const phoneNumber = '923165123719'
...
```javascript
// --- Create a new one
sock.newsletterCreate('Um4r719/baileys')

// --- Get info
sock.newsletterMetadata('120363419188352267@newsletter')

// --- Demote admin
sock.newsletterDemote('120363419188352267@newsletter', '923165123719@s.whatsapp.net')

// --- Change owner
sock.newsletterChangeOwner('120363419188352267@newsletter', '923165123719@s.whatsapp.net')

// --- Change name
sock.newsletterUpdateName('120363419188352267@newsletter', '📦 Um4r719/baileys')

// --- Change description
sock.newsletterUpdateDescription('120363419188352267@newsletter', '📣 Fresh updates weekly')

// --- Change photo
sock.newsletterUpdatePicture('120363419188352267@newsletter', {
   url: 'path/to/image.jpg'
})

// --- Remove photo
sock.newsletterRemovePicture('120363419188352267@newsletter')

// --- React to a message
sock.newsletterReactMessage('120363419188352267@newsletter', '100', '💛')
...
sock.groupCreate('Um4r719/baileys', ['923165123719@s.whatsapp.net'])
...
// --- Add participants
sock.groupParticipantsUpdate(jid, ['923165123719@s.whatsapp.net'], 'add')

// --- Remove participants
sock.groupParticipantsUpdate(jid, ['923165123719@s.whatsapp.net'], 'remove')

// --- Promote to admin
sock.groupParticipantsUpdate(jid, ['923165123719@s.whatsapp.net'], 'promote')

// --- Demote from admin
sock.groupParticipantsUpdate(jid, ['923165123719@s.whatsapp.net'], 'demote')

// --- Change name
sock.groupUpdateSubject(jid, '📦 Um4r719/baileys')

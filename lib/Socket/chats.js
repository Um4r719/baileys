...
// Umar@Note 08-02-26 --- I know it's not efficient for RSS ಥ⁠‿⁠ಥ
...
export const makeChatsSocket = (config) => {
    ...
    // Umar@Note 06-02-26 --- Quick helper only. This function exists solely for faster lookup with caching.
    const findUserId = async (pnLid) => {
        ...
        if (isPnUser(pnLid)) {
            ...
            if (!userId.lid) {
                ...
                return userId; // Umar@Note 06-02-26 --- Early return to skip caching for non-existent ID
            }
        }
        ...
        // Umar@Note 06-02-26 --- I know... it's dirty (⁠╯⁠︵⁠╰⁠,⁠)
    ...
    const profilePictureUrl = async (jid, type = 'image', timeoutMs) => {
        // Umar@Changes 06-02-26 --- Refactor profilePictureUrl() to use tctoken and adjust error handling
